...
@pytest.mark.parametrize("data, expected_output", [
    ...
    }, pytest.approx(0.0, rel=1e-4))  # Average cosine similarity should be 0
])
...
@pytest.mark.parametrize("data", [
    ...
    {
        "col1": [[0.5, 0.5], [0.2, 0.8], [0.3, 0.7]],  # Lists instead of numpy arrays
